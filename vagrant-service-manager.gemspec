...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'To provide the user a CLI to configure the ADB/CDK for different use cases and to '\
                       'provide glue between ADB/CDK and the user\'s development environment.'
  spec.description   = 'Provides setup information, including environment variables and certificates, '\
